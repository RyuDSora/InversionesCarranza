...
const Construccion = () => {
  return (
    <div className="construccion-container">
      ...
      <br />
      <br />
      <div className="construccion-section">
        <img className="construccion-img" src="https://scontent.ftgu4-1.fna.fbcdn.net/v/t39.30808-6/329193424_905818120620867_9219122127769507762_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=dd5e9f&_nc_ohc=bjmnhzn4iQ8AX_5dnFu&_nc_ht=scontent.ftgu4-1.fna&oh=00_AfAke21iiJOyEW4H3KCSVbArtp4p1CIAA5-WivMxOs3Z2A&oe=65DB6764" alt="Imagen de construcción 1" />
        <div>
      ...
      <div className="construccion-section">
        <img className="construccion-img" src="https://scontent.ftgu4-1.fna.fbcdn.net/v/t39.30808-6/325354154_5513428792119842_3233149423284415225_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=dd5e9f&_nc_ohc=HzMdDqpKJqgAX_zgLoC&_nc_ht=scontent.ftgu4-1.fna&oh=00_AfAnrGkQvKpp-035Fftkl-_fnNNrKw82Frjyj4VfRUMqVw&oe=65DAC6FC" alt="Imagen de construcción 2" />
        <div>
      ...
      <div className="construccion-section">
        <img className="construccion-img" src="https://scontent.ftgu4-1.fna.fbcdn.net/v/t39.30808-6/322258460_621170030012858_8634094977683658569_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=dd5e9f&_nc_ohc=brJv197vHagAX9NWnVl&_nc_ht=scontent.ftgu4-1.fna&oh=00_AfBqMPS2uf2ZWmd76ielA-XaXs7sQB8qdctjk-my6Gqvyg&oe=65DA8B4A" alt="Imagen de construcción 4" />
        <div>
